...
exports.ConsolidateTaskSchema1712920000003 = void 0;
const typeorm_1 = require("typeorm");
class ConsolidateTaskSchema1712920000003 {
    ...
    async addJsonColumn(queryRunner, tableName, columnName) {
    ...
    async dropTableIfExists(queryRunner, tableName) {
        if (await queryRunner.hasTable(tableName)) {
            await queryRunner.dropTable(tableName, true);
        }
    }
    async migrateTaskUsers(queryRunner) {
    ...
    async migrateTaskLabels(queryRunner) {
    ...
    async migrateTaskBookmarks(queryRunner) {
    ...
    async migrateTaskFiles(queryRunner) {
    ...
    async migrateTaskTodoFiles(queryRunner) {
    ...
    async migrateMovementHistories(queryRunner) {
...
exports.ConsolidateTaskSchema1712920000003 = ConsolidateTaskSchema1712920000003;
//# sourceMappingURL=1712920000003-consolidate-task-schema.js.map